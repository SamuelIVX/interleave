...
public final class DekkerState implements SharedState {
    private boolean[] flag;
    private int turn;
    private int inCriticalSection;

    public DekkerState(boolean[] flag, int turn, int inCriticalSection) {
    ...
    public static DekkerState of(boolean t0Wants, boolean t1Wants, int turn) {
        return new DekkerState(new boolean[]{t0Wants, t1Wants}, turn, -1);
    }
    ...
    public SharedState deepCopy() {
        return new DekkerState(new boolean[]{flag[0], flag[1]}, turn, inCriticalSection);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DekkerState that)) return false;
    ...
    public String toString() {
        ...
        return String.format("DekkerState{flag=[%b, %b], turn=%d, cs=%s}", 
