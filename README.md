...
This is a personal learning project, but issues and suggestions are welcome. Please open an issue before submitting a PR so we can align on the current spec boundary and avoid drift.
